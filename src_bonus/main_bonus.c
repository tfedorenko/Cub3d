...
/*   Updated: 2023/01/09 16:38:22 by tfedoren         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cal_render_bonus(void *ptr)
{
	...
	render_bonus(&info->img_data, info);
	rain(info);
	return (0);
}
